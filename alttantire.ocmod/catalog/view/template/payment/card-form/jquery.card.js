    ...
    function (r, e, t) {
        ...
        function c(r, e) {
            for (var t = {}, a = [], n = 0; n < r.length; n++) {
                ...
                -1 !== s ? (i[s].references++, i[s].updater(f)) : i.push({ identifier: l, updater: b(f, e), references: 1 }), a.push(l);
            }
            return a;
        }
        function p(r) {
            ...
            for ("boolean" == typeof l && ((g = l), (l = arguments[1] || {}), (s = 2)), "object" == typeof l || a.fn(l) || (l = {}); s < f; s++)
                if (null != (e = arguments[s]))
                    for (t in ("string" == typeof e && (e = e.split("")), e))
                        (n = c(l, t)), l !== (o = c(e, t)) && (g && o && (a.hash(o) || (i = a.array(o))) ? (i ? ((i = !1), (p = n && a.array(n) ? n : [])) : (p = n && a.hash(n) ? n : {}), d(l, t, r(g, p, o))) : void 0 !== o && d(l, t, o));
            return l;
        };
    },
    function (r, e, t) {
