            ...
            <Card key={product.id} className="group hover:shadow-xl transition-all duration-300 overflow-hidden">
              <CardContent className="p-0">
                ...
                <div className="p-2 sm:p-3 lg:p-4">
                  <h3 className="text-xs sm:text-sm lg:text-lg font-semibold text-gray-900 mb-1 sm:mb-2 leading-tight">
                    {product.name}
                  </h3>
              ...
              <CardFooter className="px-2 sm:px-3 lg:px-4 pb-2 sm:pb-3 lg:pb-4">
